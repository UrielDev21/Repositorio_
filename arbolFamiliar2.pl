...
es_hermano(omar, jorge).
es_hermano(jorge, omar).
es_hermano(omar, belen).
es_hermano(belen, omar).
es_hermano(jorge, belen).
es_hermano(belen, jorge).
es_hermano(julian, clara).
es_hermano(arturo, santiago).
es_hermano(santiago, arturo).
...
es_tio_de(A, C) :- es_hermano(A, B), es_progenitor(B, C).
es_tio_abuelo_de(A, D) :- es_hermano(A, B), es_abuelo_de(B, D).
es_suegro_de(A, B) :- es_progenitor(A, C), es_pareja(C, B).